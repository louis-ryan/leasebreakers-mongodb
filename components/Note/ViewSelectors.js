...
const ViewSelector = ({ view, thisIsMyNote, commenterId }) => {
    ...
    return (
        <div style={{ display: "flex", justifyContent: "space-around", backgroundColor: "white", border: "1px solid grey", borderRadius: "8px", paddingTop: "16px" }}>
            ...
            <Link href={`${router.query.id}#Details`}>
                ...
                >
                    ...
                    {view === "Details" && <div style={{ width: "100%", height: "16px", backgroundColor: "rgba(173, 55, 112, 0.378)" }} />}
            ...
            <Link href={`${router.query.id}#Photos`}>
                ...
                >
                    ...
                    {view === "Photos" && <div style={{ width: "100%", height: "16px", backgroundColor: "rgba(173, 55, 112, 0.378)" }} />}
                    <div style={{ height: "4px" }} />
                </div>
            </Link>
            ...
            <Link href={thisIsMyNote ? `${router.query.id}#Inbox` : `${router.query.id}#Conversation=${commenterId}`}>
                ...
                >
                    ...
                    {view === `Conversation=${commenterId}` && <div style={{ width: "100%", height: "16px", backgroundColor: "rgba(173, 55, 112, 0.378)" }} />}
                    {view === "Inbox" && <div style={{ width: "100%", height: "16px", backgroundColor: "rgba(173, 55, 112, 0.378)" }} />}
                    <div style={{ height: "4px" }} />
                </div>
            </Link>
        </div>
