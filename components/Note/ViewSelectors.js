    ...
    return (
        <div style={{ display: "flex", justifyContent: "space-around" }}>
            ...
            <div className='effect-regular' onClick={() => setView("Details")} style={{ padding: "0px 8px" }}>
                <svg width="40px" height="40px" viewBox="0 0 40 40" style={{ transform: "scale(1.5)", filter: view === "Details" && "brightness(0)" }}>
            ...
            <div className='effect-regular' onClick={() => setView("Photos")} style={{ padding: "0px 8px" }}>
                <svg width="40px" height="40px" viewBox="0 0 40 40" style={{ transform: "scale(1.5)", filter: view === "Photos" && "brightness(0)" }}>
            ...
            <div className='effect-regular' onClick={() => setView("Conversation")} style={{ padding: "0px 8px" }}>
                <svg width="40px" height="40px" viewBox="0 0 40 40" style={{ transform: "scale(1.5)", filter: view === "Conversation" && "brightness(0)" }}>
