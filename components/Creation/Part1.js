...
const Part1 = (props) => {
    ...
    return (
        <>
            ...
            <div style={{ marginBottom: "16px" }}>Does it have...</div>

            <div style={{ display: "flex", justifyContent: "space-between" }}>

                <div
                    className="form-bool"
                    style={{ width: "48%", border: props.formBools.petsAllowed && "4px solid pink" }}
                ...
                <div
                    className="form-bool"
                    style={{ width: "48%", border: props.formBools.parkingSpace && "4px solid pink" }}
                    onClick={() => props.setFormBools({ ...props.formBools, parkingSpace: props.formBools.parkingSpace === false ? true : false })}
                >
                    <svg width="40px" height="40px" viewBox="0 0 40 40" style={{ marginTop: "16px" }}>
                        <g id="Parking" stroke="none" strokeWidth={props.formBools.parkingSpace ? '2' : '1'} fill="none" fillRule="evenodd">
                            <ellipse id="Oval" stroke={props.formBools.parkingSpace ? "black" : "#979797"} cx="20.5" cy="19.5" rx="17" ry="16.5"></ellipse>
                            <line x1="17.5" y1="10.4347826" x2="17.5" y2="29.5652174" id="Line-5" stroke={props.formBools.parkingSpace ? "black" : "#979797"} strokeLinecap="round"></line>
                            <path d="M17.5,10.0255102 C23.1666667,10.0085034 26,11.6666667 26,15 C26,18.3333333 23.1666667,19.9914966 17.5,19.9744898" id="Line" stroke={props.formBools.parkingSpace ? "black" : "#979797"} strokeLinecap="square"></path>
                        </g>
                    </svg>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div
                    className="form-bool"
                    style={{ width: "48%", border: props.formBools.outdoorArea && "4px solid pink" }}
                    onClick={() => props.setFormBools({ ...props.formBools, outdoorArea: props.formBools.outdoorArea === false ? true : false })}
                >
                    <svg width="40px" height="40px" viewBox="0 0 40 40" style={{ marginTop: "16px" }}>
                        <g id="Outdoor" stroke="none" strokeWidth={props.formBools.outdoorArea ? '2' : '1'} fill="none" fillRule="evenodd">
                            <path d="M29.5,31.5 L10.5,31.5 L10.5,7.15679952 C11.8325195,5.32443495 15.0498054,4.5 20,4.5 C24.9501946,4.5 28.1674805,5.32443495 29.5,7.15679952 L29.5,31.5 Z" id="Rectangle" stroke={props.formBools.outdoorArea ? "black" : "#979797"}></path>
                            <rect id="Rectangle" stroke={props.formBools.outdoorArea ? "black" : "#979797"} x="6.5" y="18.5" width="28" height="19" rx="2"></rect>
                            <line x1="13" y1="19.09375" x2="13" y2="36.90625" id="Line-2-Copy" stroke={props.formBools.outdoorArea ? "black" : "#979797"} strokeLinecap="square"></line>
                            <line x1="27" y1="19.09375" x2="27" y2="36.90625" id="Line-2-Copy-2" stroke={props.formBools.outdoorArea ? "black" : "#979797"} strokeLinecap="square"></line>
                            <line x1="20" y1="19.09375" x2="20" y2="36.90625" id="Line-2" stroke={props.formBools.outdoorArea ? "black" : "#979797"} strokeLinecap="square"></line>
                            <line x1="10.5" y1="31.5" x2="7.5" y2="36.5" id="Line-3" stroke={props.formBools.outdoorArea ? "black" : "#979797"} strokeLinecap="square"></line>
                            <line x1="29.5" y1="31.5" x2="33.5" y2="36.5" id="Line" stroke={props.formBools.outdoorArea ? "black" : "#979797"} strokeLinecap="square"></line>
                            <line x1="10.5" y1="11.5" x2="29.5" y2="11.5" id="Line-4" stroke={props.formBools.outdoorArea ? "black" : "#979797"} strokeLinecap="square"></line>
                        </g>
                    </svg>
                    <p style={{ color: "grey" }}>Outdoor Terrace</p>
                </div>

                <div
                    className="form-bool"
                    style={{ width: "48%", border: props.formBools.garden && "4px solid pink" }}
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div
                    className="form-bool"
                    style={{ width: "48%", border: props.formBools.sharingWall && "4px solid pink" }}
                ...
                >
                    ...
                    <p style={{ color: "grey" }}>At least one wall</p>
                </div>

                <div
                    className="form-bool"
                    style={{ width: "48%", border: props.formBools.sharingFloor && "4px solid pink" }}
                ...
                >
                    ...
                    <p style={{ color: "grey" }}>The floor or ceiling</p>
                </div>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div
                    className="form-bool"
                    style={{ width: "48%", border: props.formBools.supermarket && "4px solid pink" }}
                ...
                <div
                    className="form-bool"
                    style={{ width: "48%", border: props.formBools.trainStation && "4px solid pink" }}
                    onClick={() => props.setFormBools({ ...props.formBools, trainStation: props.formBools.trainStation === false ? true : false })}
                >
                    <svg width="40px" height="40px" viewBox="0 0 40 40" style={{ marginTop: "16px" }}>
                        <g id="Train" stroke="none" strokeWidth={props.formBools.trainStation ? "2" : "1"} fill="none" fillRule="evenodd">
                            <rect id="Rectangle" stroke={props.formBools.trainStation ? "black" : "#979797"} x="8.5" y="6.5" width="23" height="26" rx="5"></rect>
                            <line x1="9.5" y1="10.5" x2="30.5" y2="10.5" id="Line-8" stroke={props.formBools.trainStation ? "black" : "#979797"} strokeLinecap="square"></line>
                            <line x1="9" y1="23" x2="31" y2="23" id="Line" stroke={props.formBools.trainStation ? "black" : "#979797"} strokeLinecap="square"></line>
                            <line x1="20" y1="11" x2="20" y2="22" id="Line-9" stroke={props.formBools.trainStation ? "black" : "#979797"} strokeLinecap="square"></line>
                            <circle id="Oval" stroke={props.formBools.trainStation ? "black" : "#979797"} cx="13.5" cy="27.5" r="1"></circle>
                            <circle id="Oval-Copy" stroke={props.formBools.trainStation ? "black" : "#979797"} cx="26.5" cy="27.5" r="1"></circle>
                            <line x1="11.5" y1="32.5" x2="9.5" y2="35.5" id="Line-10" stroke={props.formBools.trainStation ? "black" : "#979797"} strokeLinecap="round"></line>
                            <line x1="28.5" y1="32.5" x2="30.5" y2="35.5" id="Line-2" stroke={props.formBools.trainStation ? "black" : "#979797"} strokeLinecap="round"></line>
                        </g>
                    </svg>
